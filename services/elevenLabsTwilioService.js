...
async function makeOutboundCall(toNumber, agentPhoneNumberIdParam = null, conversationData = null) {
  try {
...
async function configurePhoneNumber(twilioPhoneNumber, twilioAccountSid, twilioAuthToken, label = "HexaHealth Phone") {
  try {
